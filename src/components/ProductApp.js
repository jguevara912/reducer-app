    ...
    <div>
        ...
        <ul>
            {products.map(product =>(
                <li key={product.id}>
                    {product.title}
                    <button onClick={() => dispatch({type: types.productShow,
                    payload: product})}>
                        Show
                    </button>
                    <button onClick={() => dispatch({type: types.productAddToCart,
                    payload: product})}>
                        Add To cart
                    </button>
                </li>
        ...
        <ul>
            {cart.map(product =>(
                <li key={product.id}>
                    ...
                    <button onClick={() => dispatch({type: types.productRemoveFromCart, payload: product.id})}>
                        Remove all
                    </button>
